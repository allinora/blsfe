...
*/
window.coverflowApp = null;

$(function () {

    coverflowApp = {

        defaultItem: parseInt($('.coverflowWrapper #coverflow').find('.img').length/2),
        //default set item to be centered on
        defaultDuration: 1000,
        //animation duration
        html: $('.coverflowWrapper div.wrapper').html(),
        imageCaption: $('.coverflowWrapper #imageCaption'),
        sliderCtrl: $('.coverflowWrapper #slider'),
        coverflowCtrl: $('.coverflowWrapper #coverflow'),
        coverflowImages: $('.coverflowWrapper #coverflow').find('.img'),
        coverflowItems: $('.coverflowWrapper .coverflowItem'),
        sliderVertical: $(".coverflowWrapper #slider-vertical"),
        ...
        getItems: function () {
            var refreshedItems = $('.coverflowWrapper .coverflowItem');
